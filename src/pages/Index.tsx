...
const Index = () => {
  ...
  const episodes = [
    ...
    },
    {
      ...
      date: '31 декабря 2025 - 1 января 2026',
      duration: '5 часов (19:00-00:00)',
      ...
      description: '🎄🎆 ГРАНДИОЗНЫЙ НОВОГОДНИЙ КОНЦЕРТ из Государственного Кремлёвского Дворца! Звёзды эстрады, феерическое шоу, невероятные спецэффекты! 31 декабря с 19:00 до полуночи. Встречайте Новый 2026 год вместе с телеканалом НОВЫЕ ДРУЗЬЯ ТВ! После обращения президента - продолжение концерта в 00:15!',
      isLive: true
    },
    {
      id: 601,
      ...
      date: '1 января 2026',
      duration: '3 часа (00:15-03:15)',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/0c5df5c7-dce3-4b9c-a068-8371c2df2196.jpg',
      category: 'Праздничный концерт',
      description: '🎉🎊 ПРОДОЛЖЕНИЕ грандиозного новогоднего концерта! Сразу после обращения президента в 00:15 - продолжаем встречать Новый год с лучшими артистами страны! Салюты, песни, танцы и праздничное настроение до самого утра! ПРЯМОЙ ЭФИР из Кремля!',
      isLive: true
    },
    {
      id: 500,
