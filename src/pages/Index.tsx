...
const Index = () => {
  ...
  const episodes = [
    ...
    {
      id: 505,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 6',
      date: '14 декабря 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep6.jpg',
      category: 'Реалити-шоу',
      description: '🌪️ Буря приближается! Испытание 1: Укрепление лагеря перед штормом. Испытание 2: Спасение припасов от воды. Испытание 3: Ночное ориентирование. Голосование: остается 6 участников! Суббота, 18:00.',
      nextEpisode: 'Выпуск 7 — 21 декабря, суббота в 18:00',
      challenges: [
        ...
        { name: 'Ночное ориентирование', description: 'Найти путь по звездам', winner: 'Кукла Барби' }
      ],
      eliminated: 'Супергерой Флэш'
    },
    {
      id: 506,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 7',
      date: '21 декабря 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep7.jpg',
      category: 'Реалити-шоу',
      description: '🔥 Обострение! Испытание 1: Стрельба из лука по мишеням. Испытание 2: Сбор редких фруктов на деревьях. Испытание 3: Переговоры о слиянии команд. Голосование: неожиданный поворот! Суббота, 18:00.',
      nextEpisode: 'Выпуск 8 — 28 декабря, суббота в 18:00',
      challenges: [
        { name: 'Стрельба из лука', description: 'Проверка меткости', winner: 'Солдатик Сэм' },
        { name: 'Сбор фруктов', description: 'Скалолазание по деревьям', winner: 'Мишка Тедди' },
        { name: 'Слияние команд', description: 'Стратегические переговоры', winner: 'Все участники' }
      ],
      eliminated: 'Пират Джек'
    },
    {
      id: 507,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 8',
      date: '28 декабря 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep8.jpg',
      category: 'Реалити-шоу',
      description: '⚔️ Финальная четверка близко! Испытание 1: Гонка на плотах до далекого острова. Испытание 2: Битва в грязи - последнее командное испытание. Испытание 3: Индивидуальный турнир силы. Голосование: остается 4 финалиста! Суббота, 18:00.',
      nextEpisode: 'Выпуск 9 — 4 января, суббота в 18:00',
      challenges: [
        { name: 'Гонка на плотах', description: 'Скорость и командная работа', winner: 'Кукла Барби' },
        { name: 'Битва в грязи', description: 'Последнее командное противостояние', winner: 'Солдатик Сэм' },
        { name: 'Турнир силы', description: 'Индивидуальное состязание', winner: 'Мишка Тедди' }
      ],
      eliminated: 'Принцесса Эльза'
    },
    {
      id: 508,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 9',
      date: '4 января 2026',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep9.jpg',
      category: 'Реалити-шоу',
      description: '🏆 Полуфинал! Финальная четверка! Испытание 1: Марафон по всему острову. Испытание 2: Головоломка из бамбука. Испытание 3: Балансировка на высоте. Драматичное голосование: кто попадет в финал? Суббота, 18:00.',
      nextEpisode: 'ФИНАЛ — 11 января, суббота в 18:00',
      challenges: [
        { name: 'Островной марафон', description: 'Бег через все локации острова', winner: 'Солдатик Сэм' },
        { name: 'Бамбуковая головоломка', description: 'Сложная логическая задача', winner: 'Кукла Барби' },
        { name: 'Высотный баланс', description: 'Пройти по канату над пропастью', winner: 'Мишка Тедди' }
      ],
      eliminated: 'Робот Вольт'
    },
    {
      id: 509,
      title: 'Игрушечный остров: Битва за выживание - ФИНАЛ',
      date: '11 января 2026',
      duration: '90 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-final.jpg',
      category: 'Реалити-шоу',
      description: '👑 ГРАНДИОЗНЫЙ ФИНАЛ! Топ-3: Мишка Тедди, Кукла Барби и Солдатик Сэм! Финальное испытание 1: Восхождение на вулкан. Финальное испытание 2: Подводное плавание к сундуку. Финальное испытание 3: Битва умов с хранителем острова. Последнее голосование определит ПОБЕДИТЕЛЯ сезона! Главный приз: 1 миллион игрушечных долларов! Суббота, 18:00.',
      challenges: [
        { name: 'Восхождение на вулкан', description: 'Самое сложное физическое испытание', winner: 'Солдатик Сэм' },
        { name: 'Подводное плавание', description: 'Найти ключ к сокровищнице', winner: 'Кукла Барби' },
        { name: 'Битва умов', description: 'Финальная интеллектуальная дуэль', winner: 'Мишка Тедди' }
      ],
      winner: 'Мишка Тедди',
