...
const Index = () => {
  ...
  const episodes = [
    ...
    {
      id: 500,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 1',
      date: '9 ноября 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep1.jpg',
      category: 'Реалити-шоу',
      description: '🏝️ Первый выпуск! 12 игрушечных участников высаживаются на таинственный остров. Испытание 1: Переправа через реку - команды строят плоты. Испытание 2: Поиск воды в джунглях - проверка на выживание. Испытание 3: Конкурс на иммунитет - кто самый ловкий? Вечернее голосование: первый участник покидает остров. Суббота, 18:00.',
      nextEpisode: 'Выпуск 2 — 16 ноября, суббота в 18:00',
      challenges: [
        { name: 'Переправа через реку', description: 'Команды строят плоты из подручных материалов', winner: 'Команда Красных' },
        { name: 'Поиск воды в джунглях', description: 'Участники ищут источник пресной воды', winner: 'Команда Синих' },
        { name: 'Конкурс на иммунитет', description: 'Индивидуальное состязание на ловкость', winner: 'Мишка Тедди' }
      ],
      eliminated: 'Робот Клинк'
    },
    {
      id: 501,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 2',
      date: '16 ноября 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep2.jpg',
      category: 'Реалити-шоу',
      description: '🔥 Остров начинает показывать свой характер! Испытание 1: Добыча огня - команды трутся палочками. Испытание 2: Рыбалка на океане - кто наловит больше? Испытание 3: Полоса препятствий в джунглях. Голосование: второй участник уходит с острова. Суббота, 18:00.',
      nextEpisode: 'Выпуск 3 — 23 ноября, суббота в 18:00',
      challenges: [
        { name: 'Добыча огня', description: 'Древний способ - трение палочек', winner: 'Команда Красных' },
        { name: 'Рыбалка на океане', description: 'Командная рыбалка с самодельными удочками', winner: 'Команда Красных' },
        { name: 'Полоса препятствий', description: 'Испытание на скорость и выносливость', winner: 'Кукла Барби' }
      ],
      eliminated: 'Динозавр Рекс'
    },
    {
      id: 502,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 3',
      date: '23 ноября 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep3.jpg',
      category: 'Реалити-шоу',
      description: '⚡ Напряжение растёт! Испытание 1: Строительство укрытия от дождя. Испытание 2: Охота на кабана в джунглях. Испытание 3: Переговоры и стратегия - кто умнее? Голосование становится жестче. Суббота, 18:00.',
      nextEpisode: 'Выпуск 4 — 30 ноября, суббота в 18:00',
      challenges: [
        { name: 'Строительство укрытия', description: 'Защита от тропического ливня', winner: 'Команда Синих' },
        { name: 'Охота на кабана', description: 'Командная охота в джунглях', winner: 'Команда Красных' },
        { name: 'Стратегическая игра', description: 'Интеллектуальное испытание', winner: 'Солдатик Сэм' }
      ],
      eliminated: 'Машинка Молния'
    },
    {
      id: 503,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 4',
      date: '30 ноября 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep4.jpg',
      category: 'Реалити-шоу',
      description: '🌊 Середина сезона! Испытание 1: Плавание к затонувшему кораблю. Испытание 2: Поиск сокровищ под водой. Испытание 3: Битва за ресурсы на пляже. Голосование: первое предательство! Суббота, 18:00.',
      nextEpisode: 'Выпуск 5 — 7 декабря, суббота в 18:00',
      challenges: [
        { name: 'Плавание к кораблю', description: 'Заплыв через бурные волны', winner: 'Команда Синих' },
        { name: 'Подводный поиск', description: 'Ныряние за сокровищами', winner: 'Команда Синих' },
        { name: 'Битва на пляже', description: 'Физическое противостояние команд', winner: 'Мишка Тедди' }
      ],
      eliminated: 'Кукла Кэти'
    },
    {
      id: 504,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 5',
      date: '7 декабря 2025',
      duration: '60 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep5.jpg',
      category: 'Реалити-шоу',
      description: '🗿 Загадки острова! Испытание 1: Разгадать древние символы. Испытание 2: Лабиринт в пещере - найти выход. Испытание 3: Прыжки со скалы в воду. Голосование: альянсы рушатся! Суббота, 18:00.',
      nextEpisode: 'Выпуск 6 — 14 декабря, суббота в 18:00',
      challenges: [
        { name: 'Древние символы', description: 'Интеллектуальная головоломка', winner: 'Команда Красных' },
        { name: 'Пещерный лабиринт', description: 'Поиск выхода в темноте', winner: 'Команда Синих' },
        { name: 'Прыжки со скалы', description: 'Испытание смелости - 10 метров высоты', winner: 'Солдатик Сэм' }
      ],
      eliminated: 'Плюшевый Кот'
    },
    {
      id: 505,
      title: 'Игрушечный остров: Битва за выживание - Выпуск 6 (ФИНАЛ)',
      date: '14 декабря 2025',
      duration: '90 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/toy-island-ep6.jpg',
      category: 'Реалити-шоу',
      description: '👑 ГРАНДИОЗНЫЙ ФИНАЛ! Буря приближается! Испытание 1: Укрепление лагеря перед штормом. Испытание 2: Спасение припасов от воды. Испытание 3: Ночное ориентирование и битва за главный приз. Финальное голосование определит ПОБЕДИТЕЛЯ сезона! Главный приз: 1 миллион игрушечных долларов! Суббота, 18:00.',
      challenges: [
        { name: 'Укрепление лагеря', description: 'Подготовка к шторму', winner: 'Команда Синих' },
        { name: 'Спасение припасов', description: 'Срочная эвакуация ресурсов', winner: 'Команда Красных' },
        { name: 'Финальное ориентирование', description: 'Найти сокровище острова', winner: 'Мишка Тедди' }
      ],
      winner: 'Мишка Тедди',
      runnerUp: 'Солдатик Сэм',
      thirdPlace: 'Кукла Барби',
      eliminated: 'Все финалисты определены'
    },
    {
      id: 550,
      title: 'Победа одна - Выпуск 1 (ПРЕМЬЕРА)',
      date: '21 ноября 2025',
      duration: '90 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/victory-one-ep1.jpg',
      category: 'Экстремальное шоу',
      description: '💥 ПРЕМЬЕРА экстремального шоу! 20 участников сражаются за главный приз в 10 миллионов! Испытание 1: Прыжок с 50-метровой вышки в воду. Испытание 2: Гонка на квадроциклах через грязь и препятствия. Испытание 3: Бокс в ринге - один на один. Только один может победить! Четверг, 20:00 на НОВЫЕ ДРУЗЬЯ ТВ.',
      nextEpisode: 'Выпуск 2 — 28 ноября, четверг в 20:00',
      challenges: [
        { name: 'Прыжок с вышки', description: '50 метров над водой - проверка смелости', winner: 'Алексей "Сокол"' },
        { name: 'Гонка на квадроциклах', description: 'Экстремальная трасса в грязи', winner: 'Мария "Гроза"' },
        { name: 'Бокс в ринге', description: 'Один раунд - один победитель', winner: 'Дмитрий "Молот"' }
      ],
      eliminated: 'Участник #17'
    },
    {
      id: 551,
      title: 'Победа одна - Выпуск 2',
      date: '28 ноября 2025',
      duration: '90 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/victory-one-ep2.jpg',
      category: 'Экстремальное шоу',
      description: '⚡ Экстрим продолжается! Испытание 1: Переправа по канату над пропастью. Испытание 2: Стрельба из лука по движущимся мишеням. Испытание 3: Силовая битва - перетягивание грузовика. Кто останется в игре? Четверг, 20:00 на НОВЫЕ ДРУЗЬЯ ТВ.',
      nextEpisode: 'Выпуск 3 — 5 декабря, четверг в 20:00',
      challenges: [
        { name: 'Канат над пропастью', description: '100 метров над землей без страховки', winner: 'Елена "Ястреб"' },
        { name: 'Стрельба из лука', description: 'Движущиеся мишени на скорости', winner: 'Алексей "Сокол"' },
        { name: 'Перетягивание грузовика', description: '10 тонн железа - испытание силы', winner: 'Дмитрий "Молот"' }
      ],
      eliminated: 'Участник #12'
    },
    {
      id: 552,
      title: 'Победа одна - Выпуск 3',
      date: '5 декабря 2025',
      duration: '90 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/victory-one-ep3.jpg',
      category: 'Экстремальное шоу',
      description: '🔥 Середина сезона! Испытание 1: Бег через огненные преграды. Испытание 2: Подводное плавание с задержкой дыхания. Испытание 3: Скалолазание на время. Борьба за выживание накаляется! Четверг, 20:00 на НОВЫЕ ДРУЗЬЯ ТВ.',
      nextEpisode: 'Выпуск 4 — 12 декабря, четверг в 20:00',
      challenges: [
        { name: 'Огненная полоса', description: 'Бег через пламя и дым', winner: 'Мария "Гроза"' },
        { name: 'Подводное испытание', description: 'Задержка дыхания на 5 минут', winner: 'Иван "Акула"' },
        { name: 'Скалолазание', description: 'Вертикальная стена 30 метров', winner: 'Елена "Ястреб"' }
      ],
      eliminated: 'Участник #8'
    },
    {
      id: 553,
      title: 'Победа одна - Выпуск 4 (ФИНАЛ)',
      date: '12 декабря 2025',
      duration: '120 мин',
      image: 'https://cdn.poehali.dev/projects/ceb65ec6-9cc6-44cc-8baf-1cef258052ca/files/victory-one-final.jpg',
      category: 'Экстремальное шоу',
      description: '👑 ГРАНДИОЗНЫЙ ФИНАЛ! Топ-5 участников в последней битве! Финальное испытание 1: Марафон по всем локациям шоу. Финальное испытание 2: Битва на высоте - бои на подвесной платформе. Финальное испытание 3: Полоса препятствий смерти. Кто получит 10 миллионов? Четверг, 20:00 на НОВЫЕ ДРУЗЬЯ ТВ.',
      challenges: [
        { name: 'Экстремальный марафон', description: 'Все испытания за один раз', winner: 'Алексей "Сокол"' },
        { name: 'Битва на высоте', description: 'Поединки на подвесной платформе', winner: 'Дмитрий "Молот"' },
        { name: 'Полоса препятствий смерти', description: 'Финальное испытание силы и духа', winner: 'Дмитрий "Молот"' }
      ],
      winner: 'Дмитрий "Молот"',
      runnerUp: 'Алексей "Сокол"',
      thirdPlace: 'Мария "Гроза"',
      eliminated: 'Определен победитель'
    },
    {
      id: 600,
