  ...
  const episodes = [
    ...
    },
    {
      ...
      videoSegments: [
        ...
        { time: '02:00-05:00', title: 'Конкурс 1: Беговая дорожка', description: 'Участники бегут через полосу препятствий в джунглях. Хищники побеждают со счётом 2:1, получают 2 кокоса' },
        { time: '05:00-08:00', title: 'Конкурс 2: Лианы и канаты', description: 'Команды качаются на лианах и собирают бананы. Травоядные выигрывают 3:2, получают 3 банана' },
        { time: '08:00-11:00', title: 'Конкурс 3: Водная переправа', description: 'Участники переправляются через реку на плотах. Хищники снова впереди 2:1, получают 2 кокоса' },
        { time: '11:00-14:00', title: 'Конкурс 4: Загадки джунглей', description: 'Интеллектуальный раунд - команды отгадывают загадки о животных. Травоядные выравнивают счёт 3:2, получают 3 банана' },
        { time: '14:00-17:00', title: 'Конкурс 5: Туннель с сюрпризами', description: 'Финальное испытание - проползти через тёмный туннель. Хищники выигрывают 2:1, получают 2 кокоса' },
        { time: '17:00-19:30', title: 'Подсчёт результатов и награждение', description: 'Рокки подсчитывает бананы и кокосы. Хищники побеждают с общим счётом 6 кокосов против 6 бананов - НИЧЬЯ! Обе команды получают призы!' },
        { time: '19:30-20:00', title: 'Прощание и анонс следующего выпуска', description: 'Рокки прощается со зрителями и анонсирует новые испытания в следующей среде' }
      ]
    },
    {
      id: 600,
